...
CREATE TABLE `zaehlerstand` (
  `id` int(11) NOT NULL,
  `zaehlernummer` varchar(255) COLLATE utf8_bin NOT NULL,
  `datum` date NOT NULL,
...
(35, '64849', '2017-01-01', 1656, 23.32, 2),
(36, '64849', '2017-05-23', 2690, 24.13, 2),
(37, '64849', '2018-01-01', 3914, 24.13, 2),
(38, '64849', '2018-05-01', 4746, 25.1, 2),
(39, '64849', '2019-01-01', 6041, 25.1, 2),
(40, '8EMTB217000753', '2017-01-01', 353, 2.27, 1),
